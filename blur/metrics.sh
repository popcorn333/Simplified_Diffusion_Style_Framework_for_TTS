...
gen=/mnt/parscratch/users/acp23xt/private/DTDM_Unet_stanage/blur/blur_inf/model.masking.b:40/test/converted/Epoch_495
out=/mnt/parscratch/users/acp23xt/private/DTDM_Unet_stanage/blur/blur_inf/model.masking.b:40/test/metrics
